...
router.get('/myorders/editorder/:id', ensureAuthenticated, ensureUser, userController.edit);
router.post('/myorders/editorder/:id', ensureAuthenticated, ensureUser, userController.update);
